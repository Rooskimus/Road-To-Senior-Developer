...
{
    // For the sake of easy note-taking I put all the classes in one file here.
    // I am aware that this is not good design in real programming!


    // The below is imagining taking a message sent to a help desk and parsing out
    // key information from the message automatically.
