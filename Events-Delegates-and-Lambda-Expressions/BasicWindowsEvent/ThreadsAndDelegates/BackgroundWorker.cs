...
namespace ThreadsAndDelegates
{
    public partial class BackgroundWorkerDemo : Form
    {
        ...
        //Even though above is on a seperate thread, the two below are on main thread.
        ...
        private void MyBackgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (!e.Cancelled) OutputLabel.Text = "BackgroundWorker Completed!";
            else OutputLabel.Text = "Cancelled!";
        }
